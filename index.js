...
/* ══════════════════════════════════════════════════════════
   THE SHAPES JOURNAL (HAUTE COUTURE EDITORIAL ENGINE)
══════════════════════════════════════════════════════════ */
let currentJournalCategory = "all";
...
const DEFAULT_JOURNAL_ARTICLES = [
    {
        ...
        role: "Founder & Master Couturier",
        date: "Aug 20, 2026",
        readTime: "5 Min Read",
        image: "images/heritage_craft.webp",
        caption: "Master karigar hand-embroidering metallic zardozi threads in the Chembur atelier",
        isFeatured: true,
        excerpt: "Exploring the delicate balance between structural internal boning and antique metal thread embroidery on raw heritage silks.",
        pullquote: "A corset is an engineering marvel. When combined with ancestral Indian zardozi, it transforms into wearable royalty.",
        calloutTitle: "Atelier Craftsmanship Highlights",
        calloutItems: [
            "Over 120 dedicated karigar hours per corset bodice",
            "18-panel ergonomic flexi-boning for weightless posture support",
            "Pure gold & silver zari threads sourced from Varanasi master weavers",
            "Seamless integration into contemporary 2-piece draped lehenga sets"
        ],
        body: `<p>Every bespoke corset crafted at Shapes begins as an architectural blueprint. We combine centuries-old metal zardozi techniques with contemporary ergonomic flexi-boning, creating silhouettes that feel weightless while sculpting an iconic royal hourglass contour.</p>
        <p>Master karigars at our Chembur boutique dedicate over 120 hours to hand-embroid every floral sprig using gold zari threads and metallic dabka wire. The result is an heirloom masterpiece that merges royal Indian craftsmanship with modern pret sensibilities.</p>
        <p>Unlike rigid Victorian corsets of the past, our bespoke designs feature breathable cotton-silk linings and flexible internal channels that contour comfortably to natural body movements throughout day-long festive celebrations.</p>`
    },
    {
        id: "art-2",
        ...
        author: "Satiinder Kaur",
        role: "Principal Couturier",
        date: "Aug 16, 2026",
        readTime: "4 Min Read",
        image: "images/hero_bridal.webp",
        caption: "Royal crimson velvet lehenga with handcrafted antique marodi and zardozi borders",
        isFeatured: false,
        ...
        pullquote: "A bridal ensemble should carry the soul of ancestral heritage and the versatility to be celebrated for generations.",
        calloutTitle: "Trousseau Planning Essentials",
        calloutItems: [
            "Select 2 convertible sets that restyle effortlessly for post-wedding dinners",
            "Prioritize pure silk drapes that soften and grow richer with time",
            "Schedule your bespoke fitting at least 8 weeks prior to ceremonies",
            "Incorporate heirloom family jewels into custom neckline calibrations"
        ],
        body: `<p>A bridal trousseau is an heirloom investment. When designing our Empress Crimson and Royal Velvet lehengas, we focus on modular versatility—allowing brides to re-style blouses with draped skirts or pair zardozi dupattas with contemporary pret drapes for future celebrations.</p>
        <p>Our personalized bridal consultations in Chembur allow every bride to customize neckline contours, sleeve lengths, and dupatta embroidery to match her wedding aesthetic and personal comfort.</p>`
    },
    {
        id: "art-3",
        title: "The Alchemy of Pure Modal Silks & Handblock Geometry",
        category: "Artisanal Fabrics",
        author: "Satiinder Kaur",
        role: "Creative Director",
        date: "Aug 12, 2026",
        readTime: "3 Min Read",
        image: "images/welcome_coord_luxury.webp",
        caption: "Pure modal silk in signature Noir Botanical print, tailored for fluid movement",
        isFeatured: false,
        ...
        pullquote: "Modal silk marries the gentle breathability of botanical fibers with the liquid drape of royal satin.",
        calloutTitle: "Why We Choose Pure Modal",
        calloutItems: [
            "100% natural cellulosic fibers derived from sustainably farmed beechwood",
            "Superior moisture regulation in tropical and warm festive climates",
            "Fluid drape that skims flattering curves without clinging or creasing",
            "Rich color absorption that preserves deep indigo and jewel-tone brilliance"
        ],
        body: `<p>Pure modal silk provides the breathability of natural fibers with the fluid, lustrous drape of royal satin. Designed for the modern discerning woman, our co-ord ensembles offer unparalleled comfort for high-tea gatherings, festive soirees, and evening celebrations.</p>
        <p>Every piece is printed using non-toxic azo-free dyes and hand-finished with French seams at our Mumbai atelier to ensure the garment feels just as luxurious on the inside as it looks on the exterior.</p>`
    },
    {
        id: "art-4",
        title: "5 Effortless Ways to Style Luxury Co-Ord Sets",
        ...
        readTime: "4 Min Read",
        image: "images/draped_corset_set.webp",
        caption: "Emerald draped 2-piece pret ensemble styled with sculptural gold accents",
        isFeatured: false,
        excerpt: "How tailored 2-piece sets transition seamlessly from morning high-teas to evening cocktail galas with zero fuss.",
        pullquote: "The magic of a coordinated set is in its duality: unmatched elegance as a pair, infinite style possibilities as separates.",
        calloutTitle: "5-Step Styling Playbook",
        calloutItems: [
            "Look 1: Power Formal &mdash; Pair the tailored tunic with slim trousers and metallic pumps",
            "Look 2: Evening Gala &mdash; Drape an organza cape or statement polki choker",
            "Look 3: Resort Luxe &mdash; Unbutton the silk shirt over linen swimwear with slides",
            "Look 4: Fusion Festive &mdash; Wear the embroidered top with a contrasting Banarasi skirt",
            "Look 5: Weekend Minimal &mdash; Pair the printed trousers with a crisp white poplin shirt"
        ],
        body: `<p>A well-tailored designer co-ord set is the hardest-working asset in a connoisseur's wardrobe. In an era where time is precious, a coordinated ensemble offers instant, impeccably balanced elegance without the fatigue of outfit matching.</p>
        <p>By styling the top and bottom as independent separates, a single SHAPES two-piece set unlocks over ten unique outfit variations across daytime, formal, and festive calendars.</p>`
    },
    {
        id: "art-5",
        title: "Festive Jewel Tones: Emerald, Royal Sapphire & Ochre",
        category: "Couture Craft",
        author: "Satiinder Kaur",
        ...
        readTime: "3 Min Read",
        image: "images/coord_royal_emerald.webp",
        caption: "Royal Emerald silk set with delicate antique gold border accents",
        isFeatured: false,
        excerpt: "Exploring the psychology and royal lineage of Indian festive colors crafted for twilight celebrations.",
        pullquote: "Colors in Indian couture are not accidental; they are visual poetry rooted in imperial court history.",
        calloutTitle: "The Royal Palette Guide",
        calloutItems: [
            "Royal Emerald: Symbol of prosperity, renewal, and timeless dignity",
            "Imperial Indigo: The depth of royal twilight, celebrated for regal evenings",
            "Antique Ochre: Warm golden sunburst hues for auspicious day celebrations",
            "Noir Botanical: Monochromatic modern sophistication with subtle gold luster"
        ],
        body: `<p>Throughout Indian textile history, deep jewel tones have symbolized nobility, auspiciousness, and artistic mastery. In our festive collections, we calibrate each dye lot under natural sunlight and warm indoor evening luminescence to ensure the colors glow radiantly under all lighting conditions.</p>`
    }
];

function getJournalArticles() {
    try {
        const stored = localStorage.getItem("shapes_journal_articles_v2");
        if (stored) {
            const parsed = JSON.parse(stored);
            if (Array.isArray(parsed) && parsed.length > 0) return parsed;
        }
    } catch(e) {}
    localStorage.setItem("shapes_journal_articles_v2", JSON.stringify(DEFAULT_JOURNAL_ARTICLES));
...
function renderJournalArticles() {
    const container = document.getElementById("journal-articles-grid");
    if (!container) return;

    const allArticles = getJournalArticles();
    const filtered = currentJournalCategory === "all" 
        ? allArticles 
        : allArticles.filter(a => a.category === currentJournalCategory);

    if (filtered.length === 0) {
        container.innerHTML = `<div style="text-align:center; padding:3rem; color:var(--grey); grid-column:1/-1;">
            <i class="fa-solid fa-feather-pointed" style="font-size:2rem; color:var(--gold); margin-bottom:1rem; display:block;"></i>
            <p>No chronicles found in this category. Showing all stories.</p>
            <button class="journal-read-btn" style="margin-top:1rem;" onclick="filterJournalCategory('all')">View All Chronicles</button>
        </div>`;
        return;
    }

    // Determine if we show a Grand Featured Card
    let featuredArticle = filtered.find(a => a.isFeatured) || filtered[0];
    let remainingArticles = filtered.filter(a => a.id !== featuredArticle.id);

    // If filtering by specific category and only 1-2 articles exist, show them in standard subgrid
    let html = "";

    if (currentJournalCategory === "all" || filtered.length > 2) {
        // Render Lead Cover Story
        html += `
        <article class="journal-featured-card" onclick="openJournalArticleModal('${featuredArticle.id}')" aria-label="${featuredArticle.title}">
            <div class="featured-img-wrap">
                <span class="featured-cover-tag"><i class="fa-solid fa-sparkles" style="color:var(--gold);"></i> Cover Chronicle</span>
                <img src="${normalizeProductImage(featuredArticle.image)}" alt="${featuredArticle.title}" loading="lazy">
            </div>
            <div class="featured-card-content">
                <div class="featured-meta-row">
                    <span class="featured-category-badge">${featuredArticle.category}</span>
                    <span>&bull;</span>
                    <span><i class="fa-regular fa-clock"></i> ${featuredArticle.readTime || '4 Min Read'}</span>
                    <span>&bull;</span>
                ...
                <div class="featured-author-row">
                    <div class="author-chip">
                        <div class="author-icon"><i class="fa-solid fa-feather-pointed"></i></div>
                        <div>
                            <span class="author-name-text">${featuredArticle.author}</span>
                            <span class="author-title-sub">${featuredArticle.role || 'Master Couturier'}</span>
                        </div>
                    </div>
                    <button type="button" class="featured-read-btn" onclick="event.stopPropagation(); openJournalArticleModal('${featuredArticle.id}')">
                        Read Chronicle &rarr;
                    </button>
                </div>
            </div>
    ...
    // Render Secondary Stories Sub-Grid
    if (remainingArticles.length > 0) {
        html += `<div class="journal-stories-subgrid">`;
        remainingArticles.forEach(art => {
            html += `
            <article class="journal-story-card" onclick="openJournalArticleModal('${art.id}')" aria-label="${art.title}">
                <div class="story-card-img-box">
                    <span class="story-category-pill">${art.category}</span>
                    <span class="story-readtime-pill"><i class="fa-regular fa-clock"></i> ${art.readTime || '3 Min'}</span>
                    <img src="${normalizeProductImage(art.image)}" alt="${art.title}" loading="lazy">
                </div>
                <div class="story-card-body">
                    ...
                    <p class="story-snippet">${art.excerpt}</p>
                    <div class="story-card-footer">
                        <span class="story-read-link">Read Story <i class="fa-solid fa-arrow-right"></i></span>
                    </div>
                </div>
            </article>`;
        });
...
function openJournalArticleModal(articleId) {
    ...
    let art = articles.find(a => a.id === articleId) || articles[0];
    if (!art) return;
    ...
    set("modal-journal-readtime", (art.readTime || "4 Min Read"));

    const captionEl = document.getElementById("modal-journal-caption");
    if (captionEl) captionEl.textContent = art.caption || "Crafted at the Shapes Chembur flagship atelier";

    // Format rich body with pullquote & callout box
    let richBodyHtml = art.body || `<p>${art.excerpt}</p>`;
    
    if (art.pullquote) {
        richBodyHtml += `
        <div class="journal-pullquote">
            <p>"${art.pullquote}"</p>
        </div>`;
    }

    if (art.calloutItems && art.calloutItems.length > 0) {
        richBodyHtml += `
        <div class="journal-callout-box">
            <h5><i class="fa-solid fa-gem" style="color:var(--gold);"></i> ${art.calloutTitle || 'Atelier Highlights'}</h5>
            <ul>
                ${art.calloutItems.map(item => `<li>${item}</li>`).join("")}
            </ul>
        </div>`;
    }

    const bodyEl = document.getElementById("modal-journal-body");
    if (bodyEl) bodyEl.innerHTML = richBodyHtml;
    ...
    // Save active article ID for sharing
    window._activeJournalArticle = art;
...
function shareJournalStory() {
    const art = window._activeJournalArticle || (getJournalArticles()[0]);
    if (!art) return;

    const text = `Read "${art.title}" on The SHAPES Journal by Satiinder Kaur:
https://shapesbysatinderkaur.com/#journal-section`;
